...
hlisp.hexp = {};
hlisp.hexp.make_hexp = function(a) {
  return cljs.core.ObjMap.fromObject("\ufdd0'children \ufdd0'text \ufdd0'data \ufdd0'attr-params \ufdd0'proc \ufdd0'env \ufdd0'params \ufdd0'attrs \ufdd0'tag".split(" "), {"\ufdd0'children":cljs.core.PersistentVector.EMPTY, "\ufdd0'text":"", "\ufdd0'data":null, "\ufdd0'attr-params":cljs.core.ObjMap.EMPTY, "\ufdd0'proc":null, "\ufdd0'env":cljs.core.ObjMap.EMPTY, "\ufdd0'params":cljs.core.PersistentVector.EMPTY, "\ufdd0'attrs":cljs.core.ObjMap.EMPTY, "\ufdd0'tag":a})
};
hlisp.hexp.make_node_hexp = function(a, b, c) {
  return cljs.core.assoc.call(null, hlisp.hexp.make_hexp.call(null, a), "\ufdd0'attrs", b, "\ufdd0'children", c)
};
hlisp.hexp.make_seq_hexp = function(a) {
  return hlisp.hexp.make_node_hexp.call(null, "val:seq", cljs.core.ObjMap.EMPTY, cljs.core.vec.call(null, a))
};
hlisp.hexp.make_text_hexp = function(a, b) {
  return cljs.core.assoc.call(null, hlisp.hexp.make_hexp.call(null, a), "\ufdd0'text", "" + cljs.core.str(b))
};
hlisp.hexp.make_prim_hexp = function(a) {
  return cljs.core.assoc.call(null, hlisp.hexp.make_hexp.call(null, "\ufdd0'prim"), "\ufdd0'proc", a)
};
hlisp.hexp.make_proc_hexp = function(a, b, c, d) {
  return cljs.core.assoc.call(null, hlisp.hexp.make_hexp.call(null, "\ufdd0'proc"), "\ufdd0'attr-params", a, "\ufdd0'params", b, "\ufdd0'env", c, "\ufdd0'proc", d)
};
clojure.browser.dom = {};
...
clojure.browser.dom._element = function() {
  var a = null, b = function(a) {
    if(a ? a.clojure$browser$dom$DOMBuilder$_element$arity$1 : a) {
    ...
    if(a ? a.clojure$browser$dom$DOMBuilder$_element$arity$2 : a) {
    ...
    if(a ? a.clojure$browser$dom$DOMBuilder$_element$arity$3 : a) {
...
clojure.browser.dom._element.string = function() {
  var a = null, b = function(a, b, e) {
    ...
    var f = cljs.core.truth_(function() {
      ...
      return a ? cljs.core.seq.call(null, b) : a
      ...
      var f;
      f = (f = cljs.core.keyword_QMARK_.call(null, c)) ? f : cljs.core.string_QMARK_.call(null, c);
      return f ? (e[cljs.core.name.call(null, c)] = d, e) : null
    }, {}, b) : null;
    clojure.browser.dom.log_obj.call(null, f);
    return cljs.core.seq.call(null, e) ? cljs.core.apply.call(null, goog.dom.createDom, cljs.core.name.call(null, a), f, cljs.core.map.call(null, clojure.browser.dom._element, e)) : goog.dom.createDom(cljs.core.name.call(null, a), f)
  };
  return a = function(a, d, e) {
    switch(arguments.length) {
      case 1:
        ...
        f = cljs.core.keyword_QMARK_.call(null, a) ? goog.dom.createElement(cljs.core.name.call(null, a)) : goog.dom.createTextNode(cljs.core.name.call(null, a));
        return f;
      case 2:
        return clojure.browser.dom.log.call(null, "string (-element ", a, " ", d, ")"), f = cljs.core.first.call(null, d), f = cljs.core.map_QMARK_.call(null, f) ? clojure.browser.dom._element.call(null, a, f, cljs.core.rest.call(null, d)) : clojure.browser.dom._element.call(null, a, null, d), f;
      case 3:
...
hlisp.reader.valid_node_expr_QMARK_ = function(a) {
  var b = cljs.core.seq_QMARK_.call(null, a);
  return b ? cljs.core.symbol_QMARK_.call(null, cljs.core.first.call(null, a)) : b
};
hlisp.reader.valid_attrlist_QMARK_ = function(a) {
  var b = cljs.core.seq_QMARK_.call(null, a);
  return b ? cljs.core.seq_QMARK_.call(null, cljs.core.first.call(null, a)) : b
};
hlisp.reader.text_node = function(a) {
  return cljs.core.list.call(null, cljs.core.symbol.call(null, "#text"), "" + cljs.core.str(a))
};
hlisp.reader.parse_symbol = function(a) {
  return cljs.core.symbol_QMARK_.call(null, a) ? cljs.core.list.call(null, a, hlisp.reader.empty_attrs) : null
};
hlisp.reader.parse_text_node = function(a) {
  return cljs.core.string_QMARK_.call(null, a) ? hlisp.reader.text_node.call(null, a) : null
};
hlisp.reader.parse_seqable_literal = function(a, b) {
  return function(c) {
    if(cljs.core.truth_(a.call(null, c))) {
      var d = cljs.core.first.call(null, c), e = cljs.core.rest.call(null, c), d = cljs.core.truth_(hlisp.reader.valid_attrlist_QMARK_.call(null, d)) ? d : hlisp.reader.empty_attrs, c = cljs.core._EQ_.call(null, hlisp.reader.empty_attrs, d) ? c : e;
      return cljs.core.concat.call(null, cljs.core.list.call(null, b, d), cljs.core.map.call(null, hlisp.reader.read_form, c))
    }
    return null
  }
};
hlisp.reader.parse_atomic_literal = function(a, b) {
  return function(c) {
    if(cljs.core.seq_QMARK_.call(null, c)) {
      var d = cljs.core.nth.call(null, c, 0, null), e = cljs.core.nth.call(null, c, 1, null);
      return(c = cljs.core._EQ_.call(null, 2, cljs.core.count.call(null, c))) ? (d = cljs.core._EQ_.call(null, "\ufdd1'quote", d)) ? (d = a.call(null, e), cljs.core.truth_(d) ? cljs.core.list.call(null, b, hlisp.reader.empty_attrs, hlisp.reader.text_node.call(null, "" + cljs.core.str(e))) : d) : d : c
    }
    return null
  }
};
hlisp.reader.parse_map_literal = function(a) {
  a = hlisp.reader.parse_seqable_literal.call(null, cljs.core.map_QMARK_, "\ufdd1'val:map").call(null, a);
  return cljs.core.truth_(a) ? cljs.core.concat.call(null, cljs.core.take.call(null, 2, a), cljs.core.mapcat.call(null, cljs.core.partial.call(null, cljs.core.drop, 2), cljs.core.drop.call(null, 2, a))) : null
};
hlisp.reader.parse_set_literal = function(a) {
  return hlisp.reader.parse_seqable_literal.call(null, cljs.core.set_QMARK_, "\ufdd1'val:set").call(null, a)
};
hlisp.reader.parse_vector_literal = function(a) {
  return hlisp.reader.parse_seqable_literal.call(null, cljs.core.vector_QMARK_, "\ufdd1'val:vec").call(null, a)
};
hlisp.reader.parse_string_literal = function(a) {
  return hlisp.reader.parse_atomic_literal.call(null, cljs.core.string_QMARK_, "\ufdd1'val:str").call(null, a)
};
hlisp.reader.parse_number_literal = function(a) {
  return hlisp.reader.parse_atomic_literal.call(null, cljs.core.number_QMARK_, "\ufdd1'val:num").call(null, a)
};
hlisp.reader.parse_node = function parse_node(b) {
  if(cljs.core.truth_(hlisp.reader.valid_node_expr_QMARK_.call(null, b))) {
    var c = cljs.core.nth.call(null, b, 0, null), d = cljs.core.nth.call(null, b, 1, null), b = cljs.core.nthnext.call(null, b, 2);
    return cljs.core.truth_(hlisp.reader.valid_attrlist_QMARK_.call(null, d)) ? cljs.core.concat.call(null, cljs.core.list.call(null, c, d), cljs.core.map.call(null, hlisp.reader.read_form, b)) : parse_node.call(null, cljs.core.remove.call(null, cljs.core.nil_QMARK_, cljs.core.concat.call(null, cljs.core.list.call(null, c, hlisp.reader.empty_attrs, d), b)))
  }
  return null
};
hlisp.reader.read_form = function(a) {
  var b = hlisp.reader.parse_symbol.call(null, a);
  if(cljs.core.truth_(b)) {
    return b
  }
  b = hlisp.reader.parse_text_node.call(null, a);
  if(cljs.core.truth_(b)) {
    return b
  }
  b = hlisp.reader.parse_map_literal.call(null, a);
  if(cljs.core.truth_(b)) {
    return b
  }
  b = hlisp.reader.parse_set_literal.call(null, a);
  if(cljs.core.truth_(b)) {
    return b
  }
  b = hlisp.reader.parse_vector_literal.call(null, a);
  if(cljs.core.truth_(b)) {
    return b
  }
  b = hlisp.reader.parse_string_literal.call(null, a);
  if(cljs.core.truth_(b)) {
    return b
  }
  b = hlisp.reader.parse_number_literal.call(null, a);
  if(cljs.core.truth_(b)) {
    return b
  }
  b = hlisp.reader.parse_node.call(null, a);
  if(cljs.core.truth_(b)) {
    return b
  }
  throw Error([cljs.core.str("Assert failed: "), cljs.core.str([cljs.core.str("read-form: "), cljs.core.str(a), cljs.core.str(" isn't a valid expression")].join("")), cljs.core.str("\n"), cljs.core.str(cljs.core.pr_str.call(null, !1))].join(""));
};
hlisp.reader.read_forms = function(a) {
  return cljs.core.map.call(null, hlisp.reader.read_form, a)
};
hlisp.reader.read_string = function(a) {
  return hlisp.reader.read_forms.call(null, cljs.reader.read_string.call(null, [cljs.core.str("("), cljs.core.str(a), cljs.core.str("\n)")].join("")))
};
hlisp.util = {};
...
hlisp.util.funroll_body = cljs.core.partial.call(null, cljs.core.reduce, function(a, b) {
  return function() {
    var c = function(c) {
      cljs.core.apply.call(null, a, c);
      return cljs.core.apply.call(null, b, c)
    }, d = function(a) {
      var b = null;
      goog.isDef(a) && (b = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
...
hlisp.util.funroll_seq = function(a) {
  return function() {
    var b = function(b) {
      return cljs.core.map.call(null, function(a) {
        return cljs.core.apply.call(null, a, b)
...
hlisp.compiler = {};
hlisp.compiler.read_attrs_pairs = function(a) {
  return cljs.core.map.call(null, function(a) {
    return cljs.core.list.call(null, cljs.core.first.call(null, a), cljs.core.string_QMARK_.call(null, cljs.core.second.call(null, a)) ? cljs.core.second.call(null, a) : "")
  }, cljs.core.filter.call(null, function(a) {
    return cljs.core.symbol_QMARK_.call(null, cljs.core.first.call(null, a))
  }, cljs.core.partition.call(null, 2, cljs.core.interleave.call(null, a, cljs.core.concat.call(null, cljs.core.rest.call(null, a), cljs.core.list.call(null, cljs.core.last.call(null, a)))))))
};
hlisp.compiler.read_attrs = function(a) {
  return cljs.core.into.call(null, cljs.core.ObjMap.EMPTY, cljs.core.vec.call(null, cljs.core.map.call(null, cljs.core.vec, hlisp.compiler.read_attrs_pairs.call(null, a))))
};
hlisp.compiler.compile_text_hexp = function(a) {
  var b = cljs.core.nth.call(null, a, 0, null), a = cljs.core.nth.call(null, a, 1, null), b = "" + cljs.core.str(b);
  return cljs.core._EQ_.call(null, "#", cljs.core.first.call(null, b)) ? hlisp.hexp.make_text_hexp.call(null, b, a) : null
};
hlisp.compiler.compile_node_hexp = function(a) {
  var b = cljs.core.nth.call(null, a, 0, null), c = cljs.core.nth.call(null, a, 1, null), c = cljs.core.nth.call(null, c, 0, null), c = cljs.core.nthnext.call(null, c, 0), a = cljs.core.nthnext.call(null, a, 2), b = "" + cljs.core.str(b);
  return cljs.core.not_EQ_.call(null, "#", cljs.core.first.call(null, b)) ? hlisp.hexp.make_node_hexp.call(null, b, hlisp.compiler.read_attrs.call(null, c), cljs.core.map.call(null, hlisp.compiler.compile_form, a)) : null
};
hlisp.compiler.compile_form = function(a) {
  var b = hlisp.compiler.compile_text_hexp.call(null, a);
  if(cljs.core.truth_(b)) {
    return b
  }
  b = hlisp.compiler.compile_node_hexp.call(null, a);
  if(cljs.core.truth_(b)) {
    return b
  }
  throw Error([cljs.core.str("Assert failed: "), cljs.core.str([cljs.core.str("compile: "), cljs.core.str(a), cljs.core.str(" is not a valid expression")].join("")), cljs.core.str("\n"), cljs.core.str(cljs.core.pr_str.call(null, !1))].join(""));
};
hlisp.compiler.compile_forms = function(a) {
  return cljs.core.map.call(null, hlisp.compiler.compile_form, a)
};
hlisp.compiler.decompile_text_hexp = function(a) {
  var b = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, a = cljs.core._lookup.call(null, b, "\ufdd0'text", null), b = cljs.core._lookup.call(null, b, "\ufdd0'tag", null);
  return cljs.core._EQ_.call(null, "#", cljs.core.first.call(null, b)) ? cljs.core.list.call(null, cljs.core.symbol.call(null, b), a) : null
};
hlisp.compiler.decompile_node_hexp = function(a) {
  var b = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, a = cljs.core._lookup.call(null, b, "\ufdd0'children", null), c = cljs.core._lookup.call(null, b, "\ufdd0'attrs", null), b = cljs.core._lookup.call(null, b, "\ufdd0'tag", null);
  return cljs.core.string_QMARK_.call(null, b) ? cljs.core.concat.call(null, cljs.core.list.call(null, cljs.core.symbol.call(null, b), cljs.core.list.call(null, cljs.core.mapcat.call(null, hlisp.util.zipfn.call(null, cljs.core.PersistentVector.fromArray([cljs.core.symbol, cljs.core.str], !0)), c))), cljs.core.map.call(null, hlisp.compiler.decompile_hexp, a)) : null
};
hlisp.compiler.decompile_hexp = function(a) {
  var b = hlisp.compiler.decompile_text_hexp.call(null, a);
  return cljs.core.truth_(b) ? b : hlisp.compiler.decompile_node_hexp.call(null, a)
};
hlisp.compiler.decompile_hexps = function(a) {
  return cljs.core.map.call(null, hlisp.compiler.decompile_hexp, a)
};
clojure.set = {};
...
hlisp.interpreter.resolve_env = function(a, b) {
  var c = cljs.core._lookup.call(null, a, b, null);
  return cljs.core.truth_(c) ? c : cljs.core._lookup.call(null, cljs.core.deref.call(null, hlisp.interpreter._STAR_global_env_STAR_), b, null)
};
hlisp.interpreter.html_tags = cljs.core.PersistentHashSet.fromArray("dd big col head sub tt basefont a output b figcaption body rt details tfoot nav acronym pre img form iframe figure meta section caption summary bdi small noframes wbr var dl em fieldset isindex datalist i h1 meter h2 hr span data input del h3 script track command html dfn h4 noscript optgroup legend bdo dir param area h5 frame kbd code progress header mark time h6 sup table ins font blockquote br p dt td abbr q samp div keygen style base button strike s thead th label address center u option eventsource frameset tbody article audio cite ul strong hgroup aside canvas title embed applet ruby textarea link source video footer select map li ol rp tr colgroup menu object".split(" "));
hlisp.interpreter.html_text_tags = cljs.core.PersistentHashSet.fromArray(["#text", "#comment"]);
hlisp.interpreter.hlisp_boxed_tags = cljs.core.PersistentHashSet.fromArray("val:map val:seq val:true val:set val:false val:num val:nil val:str val:vec".split(" "));
...
hlisp.interpreter.elems = function(a) {
  return cljs.core.remove.call(null, hlisp.interpreter.text_hexp_QMARK_, a)
};
hlisp.interpreter.text_hexp_QMARK_ = function(a) {
  return cljs.core._EQ_.call(null, "#", cljs.core._lookup.call(null, (new cljs.core.Keyword("\ufdd0'tag")).call(null, a), 0, null))
};
hlisp.interpreter.self_evaluating_hexp_QMARK_ = function(a) {
  var b = cljs.core.contains_QMARK_.call(null, hlisp.interpreter.self_evaluating_tags, (new cljs.core.Keyword("\ufdd0'tag")).call(null, a));
  return b ? b : hlisp.interpreter.text_hexp_QMARK_.call(null, a)
};
hlisp.interpreter.has_tag_QMARK_ = function(a, b) {
  return cljs.core._EQ_.call(null, a, (new cljs.core.Keyword("\ufdd0'tag")).call(null, b))
};
...
hlisp.interpreter.analyze_self_evaluating = function(a) {
  if(cljs.core.truth_(hlisp.interpreter.self_evaluating_hexp_QMARK_.call(null, a))) {
    var b = cljs.core.mapv.call(null, hlisp.interpreter.analyze, (new cljs.core.Keyword("\ufdd0'children")).call(null, a));
    return function(c) {
      return cljs.core.assoc.call(null, a, "\ufdd0'children", cljs.core.mapv.call(null, function(a) {
...
hlisp.interpreter.analyze_quoted = function(a) {
  return cljs.core.truth_(hlisp.interpreter.quoted_hexp_QMARK_.call(null, a)) ? function() {
    return cljs.core.first.call(null, hlisp.interpreter.elems.call(null, (new cljs.core.Keyword("\ufdd0'children")).call(null, a)))
  } : null
};
hlisp.interpreter.analyze_def = function(a) {
  if(cljs.core.truth_(hlisp.interpreter.def_hexp_QMARK_.call(null, a))) {
    var a = hlisp.interpreter.elems.call(null, (new cljs.core.Keyword("\ufdd0'children")).call(null, a)), a = hlisp.util.zipfn.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'tag", hlisp.interpreter.analyze], !0)).call(null, a), b = cljs.core.nth.call(null, a, 0, null), c = cljs.core.nth.call(null, a, 1, null);
    return function(a) {
      a = c.call(null, a);
      hlisp.interpreter.bind_global_BANG_.call(null, cljs.core.PersistentArrayMap.fromArrays([b], [a]));
      return null
    }
  }
  return null
};
hlisp.interpreter.analyze_fn = function(a) {
  if(cljs.core.truth_(hlisp.interpreter.fn_hexp_QMARK_.call(null, a))) {
    var b = hlisp.interpreter.elems.call(null, (new cljs.core.Keyword("\ufdd0'children")).call(null, a)), a = cljs.core.nth.call(null, b, 0, null), b = cljs.core.nthnext.call(null, b, 1), c = cljs.core.mapv.call(null, "\ufdd0'tag", (new cljs.core.Keyword("\ufdd0'children")).call(null, a)), d = (new cljs.core.Keyword("\ufdd0'attrs")).call(null, a), e = hlisp.interpreter.analyze_body.call(null, b);
    if(!cljs.core.seq.call(null, b)) {
      throw Error([cljs.core.str("Assert failed: "), cljs.core.str("empty body"), cljs.core.str("\n"), cljs.core.str(cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'seq", "\ufdd1'body"), cljs.core.hash_map("\ufdd0'line", 99))))].join(""));
    }
    return function(a) {
      return hlisp.hexp.make_proc_hexp.call(null, d, c, a, e)
    }
  }
  return null
};
hlisp.interpreter.analyze_node = function(a) {
  var b = (new cljs.core.Keyword("\ufdd0'tag")).call(null, a), c = (new cljs.core.Keyword("\ufdd0'attrs")).call(null, a), d = hlisp.interpreter.analyze_seq.call(null, hlisp.interpreter.elems.call(null, (new cljs.core.Keyword("\ufdd0'children")).call(null, a)));
  return function(a) {
    var f = hlisp.interpreter.resolve_env.call(null, a, b);
    d.call(null, a);
    if(!cljs.core.truth_(f)) {
      throw Error([cljs.core.str("Assert failed: "), cljs.core.str([cljs.core.str("eval: unbound variable "), cljs.core.str(b)].join("")), cljs.core.str("\n"), cljs.core.str(cljs.core.pr_str.call(null, "\ufdd1'proc"))].join(""));
    }
    return hlisp.interpreter.apply_STAR_.call(null, f, c, d.call(null, a))
  }
};
hlisp.interpreter.analyze = function(a) {
  var b = hlisp.interpreter.analyze_self_evaluating.call(null, a);
  if(cljs.core.truth_(b)) {
    return b
  }
  b = hlisp.interpreter.analyze_quoted.call(null, a);
  if(cljs.core.truth_(b)) {
    return b
  }
  b = hlisp.interpreter.analyze_def.call(null, a);
  if(cljs.core.truth_(b)) {
    return b
  }
  b = hlisp.interpreter.analyze_fn.call(null, a);
  return cljs.core.truth_(b) ? b : hlisp.interpreter.analyze_node.call(null, a)
};
...
hlisp.interpreter.eval_STAR_ = function(a) {
  return hlisp.compiler.decompile_hexps.call(null, cljs.core.remove.call(null, cljs.core.nil_QMARK_, hlisp.interpreter.analyze_forms.call(null, a).call(null, cljs.core.ObjMap.EMPTY)))
};
hlisp.interpreter.parse_bindings = function parse_bindings(b, c) {
  var d = cljs.core.first.call(null, b), e = cljs.core.first.call(null, c);
  if(cljs.core._EQ_.call(null, "&", d)) {
    return parse_bindings.call(null, cljs.core.rest.call(null, b), cljs.core.list.call(null, hlisp.hexp.make_seq_hexp.call(null, c)))
  }
  if(cljs.core.truth_(cljs.core.truth_(d) ? e : d)) {
    return cljs.core.into.call(null, cljs.core.PersistentArrayMap.fromArrays([d], [e]), parse_bindings.call(null, cljs.core.rest.call(null, b), cljs.core.rest.call(null, c)))
  }
  if(cljs.core.truth_(cljs.core.truth_(d) ? d : e)) {
    throw Error([cljs.core.str("Assert failed: "), cljs.core.str("arity mismatch"), cljs.core.str("\n"), cljs.core.str(cljs.core.pr_str.call(null, !1))].join(""));
  }
  return null
};
hlisp.interpreter.apply_fn = function(a, b, c) {
  if(cljs.core.truth_(function() {
    var b = cljs.core.seq.call(null, c);
    return b ? cljs.core._EQ_.call(null, "\ufdd0'proc", (new cljs.core.Keyword("\ufdd0'tag")).call(null, a)) : b
  }())) {
    var b = (new cljs.core.Keyword("\ufdd0'proc")).call(null, a), d = (new cljs.core.Keyword("\ufdd0'params")).call(null, a);
    (new cljs.core.Keyword("\ufdd0'attr-params")).call(null, a);
    d = hlisp.interpreter.bind_env.call(null, (new cljs.core.Keyword("\ufdd0'env")).call(null, a), hlisp.interpreter.parse_bindings.call(null, d, c));
    return b.call(null, d)
  }
  return null
};
hlisp.interpreter.apply_prim = function(a, b, c) {
  return cljs.core.truth_(function() {
    var b = cljs.core.seq.call(null, c);
    return b ? cljs.core._EQ_.call(null, "\ufdd0'prim", (new cljs.core.Keyword("\ufdd0'tag")).call(null, a)) : b
  }()) ? (new cljs.core.Keyword("\ufdd0'proc")).call(null, a).call(null, b, c) : null
};
hlisp.interpreter.apply_node = function(a, b, c) {
  return cljs.core.update_in.call(null, cljs.core.update_in.call(null, a, cljs.core.PersistentVector.fromArray(["\ufdd0'children"], !0), cljs.core.into, c), cljs.core.PersistentVector.fromArray(["\ufdd0'attrs"], !0), cljs.core.into, b)
};
hlisp.interpreter.apply_STAR_ = function(a, b, c) {
  var d = hlisp.interpreter.apply_fn.call(null, a, b, c);
  if(cljs.core.truth_(d)) {
    return d
  }
  d = hlisp.interpreter.apply_prim.call(null, a, b, c);
  return cljs.core.truth_(d) ? d : hlisp.interpreter.apply_node.call(null, a, b, c)
};
hlisp.interpreter.bind_primitive_BANG_ = function(a) {
  return hlisp.interpreter.bind_global_BANG_.call(null, cljs.core.into.call(null, cljs.core.ObjMap.EMPTY, cljs.core.mapv.call(null, cljs.core.comp.call(null, cljs.core.vec, hlisp.util.zipfn.call(null, cljs.core.PersistentVector.fromArray([cljs.core.str, hlisp.hexp.make_prim_hexp], !0))), cljs.core.partition.call(null, 2, a))))
};
hlisp.primitives = {};
hlisp.primitives.prims = cljs.core.PersistentVector.fromArray(["foop", function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, d = cljs.core._lookup.call(null, c, "\ufdd1'hey", null);
  return cljs.core.assoc.call(null, hlisp.hexp.make_hexp.call(null, "div"), "\ufdd0'children", cljs.core.vec.call(null, b), "\ufdd0'attrs", cljs.core.into.call(null, cljs.core.PersistentArrayMap.fromArrays(["\ufdd1'asdf"], [d]), c))
}], !0);
hlisp.dom = {};
hlisp.dom.node_types = cljs.core.PersistentArrayMap.fromArrays([1], ["\ufdd0'element"]);
hlisp.dom.branch_QMARK_ = function(a) {
  var b = null != a;
  return b ? cljs.core._EQ_.call(null, "\ufdd0'element", hlisp.dom.node_types.call(null, a.nodeType)) : b
};
hlisp.dom.nodelist_seq = function(a) {
  return cljs.core.truth_(a) ? cljs.core.map.call(null, function(b) {
    return a.item(b)
  }, cljs.core.range.call(null, 0, a.length)) : null
};
hlisp.dom.specified_attr_nodes = function(a) {
  return cljs.core.filter.call(null, function(a) {
    return a.specified
  }, hlisp.dom.nodelist_seq.call(null, a.attributes))
};
hlisp.dom.attr_kv = function(a, b) {
  var c = cljs.core.symbol.call(null, b.nodeName.toLowerCase()), d;
  d = cljs.core._EQ_.call(null, "style", c) ? a.style.cssText : b.nodeValue;
  return cljs.core.list.call(null, c, d)
};
hlisp.dom.ie7_value = function(a) {
  var b;
  b = hlisp.dom.branch_QMARK_.call(null, a);
  b = cljs.core.truth_(b) ? a.value : b;
  return cljs.core.truth_(b) ? cljs.core.list.call(null, "value", a.value) : cljs.core.List.EMPTY
};
hlisp.dom.build_attrs = function(a) {
  return cljs.core.list.call(null, cljs.core.list.call(null, cljs.core.concat.call(null, cljs.core.mapcat.call(null, cljs.core.partial.call(null, hlisp.dom.attr_kv, a), hlisp.dom.specified_attr_nodes.call(null, a)), hlisp.dom.ie7_value.call(null, a))))
};
hlisp.dom.dom__GT_list = function dom__GT_list(b) {
  var c = b.nodeName.toLowerCase(), d = cljs.core.not_EQ_.call(null, "#", cljs.core.first.call(null, c)) ? hlisp.dom.build_attrs.call(null, b) : cljs.core.List.EMPTY, b = cljs.core.truth_(hlisp.dom.branch_QMARK_.call(null, b)) ? cljs.core.map.call(null, dom__GT_list, hlisp.dom.nodelist_seq.call(null, b.childNodes)) : cljs.core.list.call(null, b.nodeValue);
  return cljs.core.concat.call(null, cljs.core.list.call(null, cljs.core.symbol.call(null, c)), d, b)
};
hlisp.dom.read_dom = function(a) {
  return cljs.core.list.call(null, hlisp.dom.dom__GT_list.call(null, a))
};
hlisp.main = {};
hlisp.interpreter.bind_primitive_BANG_.call(null, hlisp.primitives.prims);
hlisp.main.as_forms = cljs.core.comp.call(null, clojure.browser.dom.log, hlisp.interpreter.eval_STAR_, hlisp.reader.read_forms);
console.time("load time");
hlisp.main.as_forms.call(null, cljs.core.with_meta(cljs.core.list(cljs.core.with_meta(cljs.core.list("\ufdd1'def", "\ufdd1'f", cljs.core.with_meta(cljs.core.list("\ufdd1'fn", cljs.core.vec(["\ufdd1'x", "\ufdd1'&", "\ufdd1'y"]), "\ufdd1'x"), cljs.core.hash_map("\ufdd0'line", 21))), cljs.core.hash_map("\ufdd0'line", 21)), cljs.core.with_meta(cljs.core.list("\ufdd1'def", "\ufdd1'ttt", cljs.core.with_meta(cljs.core.list("\ufdd1'f", cljs.core.with_meta(cljs.core.list("\ufdd1'ul", cljs.core.with_meta(cljs.core.list("\ufdd1'li", 
"one"), cljs.core.hash_map("\ufdd0'line", 24)), cljs.core.with_meta(cljs.core.list("\ufdd1'li", "two"), cljs.core.hash_map("\ufdd0'line", 25))), cljs.core.hash_map("\ufdd0'line", 24))), cljs.core.hash_map("\ufdd0'line", 23))), cljs.core.hash_map("\ufdd0'line", 22)), cljs.core.with_meta(cljs.core.list("\ufdd1'foop", cljs.core.with_meta(cljs.core.list(cljs.core.with_meta(cljs.core.list("\ufdd1'hey", "omfg", "\ufdd1'yo", "wheep"), cljs.core.hash_map("\ufdd0'line", 27))), cljs.core.hash_map("\ufdd0'line", 
27)), "\ufdd1'p"), cljs.core.hash_map("\ufdd0'line", 27))), cljs.core.hash_map("\ufdd0'line", 19)));
clojure.browser.dom.log.call(null, hlisp.interpreter.eval_STAR_.call(null, hlisp.dom.read_dom.call(null, document.body)));
...
hlisp.zip = {};
hlisp.zip.append_children_BANG_ = function(a, b) {
  var c = cljs.core.seq.call(null, b);
  if(c) {
    for(var d = cljs.core.first.call(null, c);;) {
      if(a.appendChild(d), d = cljs.core.next.call(null, c)) {
        c = d, d = cljs.core.first.call(null, c)
      }else {
        return null
      }
...
hlisp.zip.dom_zip = function(a) {
  return clojure.zip.zipper.call(null, function(a) {
    var c = null != a;
    return c ? cljs.core._EQ_.call(null, "\ufdd0'element", hlisp.zip.node_types.call(null, a.nodeType)) : c
  }, function(a) {
    return hlisp.zip.nodelist_seq.call(null, a.childNodes)
  }, function(a, c) {
    hlisp.zip.append_children_BANG_.call(null, a, c);
    return a
  }, a)
};
hlisp.zip.dom_seq = function dom_seq(b) {
  return cljs.core.filter.call(null, cljs.core.identity, new cljs.core.LazySeq(null, !1, function() {
    return cljs.core.truth_(clojure.zip.end_QMARK_.call(null, b)) ? null : cljs.core.cons.call(null, clojure.zip.node.call(null, b), dom_seq.call(null, clojure.zip.next.call(null, b)))
  }, null))
};
hlisp.zip.postwalk_replace = function(a, b) {
  for(;;) {
    if(cljs.core.not.call(null, clojure.zip.end_QMARK_.call(null, a))) {
      var c = clojure.zip.next.call(null, function(a, b) {
        return function(a) {
          return clojure.zip.replace.call(null, a, b.call(null, clojure.zip.node.call(null, a)))
        }
      }(a, b)), d = b, a = c, b = d
    }else {
      return clojure.zip.node.call(null, clojure.zip.root.call(null, a))
    }
  }
};
hlisp.zip.doit = function() {
  return hlisp.zip.eval.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'js/alert", "hi there"), cljs.core.hash_map("\ufdd0'line", 28)))
};
